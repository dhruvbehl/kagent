...
func NewKAgentRemoteA2ATool(name, description, baseURL string, timeout *time.Duration, extraHeaders map[string]string, propagateToken bool) (tool.Tool, string, error) {
	httpClient := &http.Client{}
	if timeout != nil {
